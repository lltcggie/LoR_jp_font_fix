Library of Ruina 日本語が□になるの修正ツール ver1.0.2

●説明
Library of Ruina ver 1.0.0.2bにおいて発生している、日本語表示だと一部が「□」になる現象を修正するツールです。
...
2020/05/30 ver1.0.2
 ver 1.0.0.2bに対応
 8192 ShipporiMincho-TTF-Regularを専用フォントで置き換えるように変更
2020/05/23 ver1.0.1
 自分で見た範囲では□がなくなった
2020/05/23 ver1.0.0
 公開
