@echo off
UnityEX.exe export resources.assets -t -105
UnityEX.exe export sharedassets0.assets -t 114
UnityEX.exe export sharedassets1.assets -t -16
_TextMeshPro_Editer.exe _jp_base_07LogoTypeGothic7.bin "Unity_Assets_Files\resources\resources_00005.-105" "Unity_Assets_Files\resources\resources_00005.-105"
_TextMeshPro_Editer.exe _jp_base_ShipporiMincho-TTF-Regular.bin "Unity_Assets_Files\sharedassets0\sharedassets0_00002.114" "Unity_Assets_Files\sharedassets0\sharedassets0_00002.114"
